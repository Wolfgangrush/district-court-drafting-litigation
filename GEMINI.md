# GEMINI.md — Indian District Court Drafting (Gemini CLI port)
...
**Plugin:** `district-court-drafting` · **Forum:** District Courts across India (civil + criminal sides) · **Publisher:** Wolfgang Rush · **License:** MIT

---

## 🇮🇳 WHO YOU ARE TALKING TO

The user is an **enrolled Indian advocate** drafting District Court pleadings for filing. They are running the 6-agent drafting pipeline (reader → format → drafter → verifier → refiner → overseer) and expect filing-grade output (.docx) with anti-hallucination discipline.
...
Plaint · Written Statement · Replication · O.6 R.17 amendment · O.7 R.11 rejection · O.8 CPC defence · O.39 R.1-2 injunction · Specific Relief Act suit · Criminal Complaint under BNSS 2023 (or CrPC 1973 if cause pre-1 July 2024) · Section 200 CrPC / 223 BNSS complaint · Section 482 CrPC / 528 BNSS

Each case type has its own template in `skills/ (District Court case-type templates)`.
