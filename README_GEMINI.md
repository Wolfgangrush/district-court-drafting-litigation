# 🇮🇳 Indian District Court Drafting — Gemini CLI Port

> The same `district-court-drafting` pipeline you know, now invokable from Gemini CLI. **Same 6-agent pipeline. Same canonical agent specs. Same filing-grade output. Different LLM brain.**
...
├── skills/ (District Court case-type templates)                   ← case-type templates (unchanged)
├── .gemini/                         ← NEW
│   └── commands/
...
**Forum:** District Courts across India (civil + criminal sides)

**Case types covered:** Plaint · Written Statement · Replication · O.6 R.17 amendment · O.7 R.11 rejection · O.8 CPC defence · O.39 R.1-2 injunction · Specific Relief Act suit · Criminal Complaint under BNSS 2023 (or CrPC 1973 if cause pre-1 July 2024) · Section 200 CrPC / 223 BNSS complaint · Section 482 CrPC / 528 BNSS
